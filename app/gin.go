...
import (
	...
	"github.com/FarmerChillax/stark/internal/metrics"
	"github.com/FarmerChillax/stark/internal/middlewares"
	"github.com/FarmerChillax/stark/internal/xlog"
	"github.com/FarmerChillax/stark/pkg/helper"
	"github.com/gin-gonic/gin"
)

func (app *Builder) ListenGinServer(ginApp *stark.GinApplication) error {
	ginApp.Application = app.Application
	engine := gin.New()

	if ginApp.TracerLogger == nil {
		ginApp.TracerLogger = helper.NewLogger(xlog.NewFormatter())
	}
